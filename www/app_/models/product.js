define(['models/base','utils','localstorage'],function(Base,Utils,localstorage){
    var Product = Base.Model.extend({     
        ...
        get_image_url:function(app){          
          app = app || this.app;          
//          var datadir = 'file:///storage/emulated/0/Android/data/com.vardion.catalog/files/';
          return app.data_dir + 'product/image/'+ this.id +'.png';          
//            return datadir + this.id +'.png';
        },
        ...
        save_image:function(id,base64){
            return Utils.saveBase64( 'product/image',  id + '.png',base64,'image/png');
        },
    });
    ...
    var ProductCollection = Base.Collection.extend({
        ...
        parse:function(res){        
            ...
            this.offset = this.offset + res.records.length;
            return res.records;            
        }, 
        prepare_directory:function(dir){                        
            ...
            if (!dir) return;
            dir.getDirectory('product',{create:true},function(proddir){
